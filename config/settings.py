...
if DB_ENGINE == "mysql":
    DATABASES = {
        "default": {
            ...
            "NAME": os.getenv("DB_NAME", "hungry_people"),
            "USER": os.getenv("DB_USER", "hungry_user"),
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "Hungry People <noreply@example.com>")
